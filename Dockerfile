...
# tzdata is not in alpine by default; without it Node silently falls back to UTC
# and every parsed event time shifts by 1-2 hours. See TZ below.
...
# create the WAL/SHM sidecar files next to events.db.
